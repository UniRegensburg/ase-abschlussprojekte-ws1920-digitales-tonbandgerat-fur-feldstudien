...
class MarkerItemAdapter(
    private val editMarkersViewModel: EditMarkersViewModel
    ...
    private val markerUserActionsListener = object : MarkerUserActionsListener {
        ...
        override fun onMarkerDeleteClicked(
            markerEntity: MarkerEntity
        ) {
...
class MarkerDiffCallback : DiffUtil.ItemCallback<MarkerEntity>() {
    ...
    override fun areItemsTheSame(
        oldItem: MarkerEntity,
        newItem: MarkerEntity
    ): Boolean {
